...
interface NavigationItmsProps{
    id:string;
    imageUrl:string;
    name:string;
}
const NavigationItem = ({id,name,imageUrl}:NavigationItmsProps) => {
    ...
    return ( 
       <ActionTooltip side="right" align="center" label={name}>
            <button onClick={onClick} className="group relative flex pb-1 items-center" >
